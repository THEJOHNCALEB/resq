            ...
            child: Row(
              children: [
                Column(
                  ...
                  children: [
                    Text('ResQ', style: theme.textTheme.headlineMedium?.copyWith(
                      fontWeight: FontWeight.w700, color: AppColors.primary, letterSpacing: -1, fontSize: 28)),
                    Row(children: [
                      ...
                      Text(gemma.modelLoaded ? 'Gemma 4' : 'Offline',
                  ...
                  child: ListenableBuilder(
                    ...
                    builder: (context, _) {
                      ...
                      return Container(
                        ...
                        child: Text(
                          count == 0 ? '0 outbound' : '$count outbound${count > 1 ? 's' : ''}',
                          style: theme.textTheme.labelSmall?.copyWith(
                            color: count == 0 ? AppColors.safe : AppColors.error, fontWeight: FontWeight.w600),
                        ),
                      );
                    },
                  ),
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: AppColors.emergency.withAlpha(60), blurRadius: 32, spreadRadius: 8)],
                ),
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  const AppIcon(Icons.warning_rounded, color: Colors.white, size: 52),
                  const SizedBox(height: 6),
                  Text('Start\nEmergency', textAlign: TextAlign.center,
          ...
          return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(count == 0 ? 'Privacy Verified' : '$count Outbound Request${count > 1 ? 's' : ''}',
                  style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700)),
                const SizedBox(height: 4),
                Text(count == 0 ? 'No data has ever left this device.' : 'Network activity detected',
                  style: theme.textTheme.bodySmall?.copyWith(color: AppColors.onSurfaceVariant)),
              ])),
            ]),
            const SizedBox(height: 24),
            Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: AppColors.primary.withAlpha(8), borderRadius: BorderRadius.circular(14)),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Every HTTP request is intercepted and counted. After the initial model download, the counter should remain at zero. This is a live measurement, not a claim.',
            ...
            if (hosts.isNotEmpty) ...[
              ...
              const SizedBox(height: 8),
              ...hosts.map((h) => Padding(padding: const EdgeInsets.only(bottom: 4),
                child: Text(h, style: theme.textTheme.bodySmall?.copyWith(color: AppColors.onSurfaceVariant, fontSize: 11)))),
            ],
            const SizedBox(height: 24),
